...
<div class="wrapper">
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Admin (Owner)</span>
            </a>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ url('admin/categories/create')}}"><i class="fa fa-circle-o"></i> Create Category</a></li>
        ...
        <li><a href="{{ url('admin/orders')}}"><i class="fa fa-circle-o text-yellow"></i> <span>All Orders</span></a></li>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2017 Admin.com, All rights reserved.
  </footer>

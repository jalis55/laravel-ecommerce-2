...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="{{route('my.account')}}" class="logo">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      <span class="logo-mini"><b>H</span>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="{{asset('/public/images/users/User.jpg')}}" class="user-image" alt="User Image">
              <span class="hidden-xs">{{Auth::user()->name}}</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="{{asset('/public/images/users/User.jpg')}}" class="img-circle" alt="User Image">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        <li class="treeview">
          <a href="#">
            <i class="fa fa-dashboard"></i> <span>My Orders</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="{{route('my.pending.order')}}"><i class="fa fa-circle-o"></i> Pending Orders</a></li>
            <li><a href="{{route('my.orders')}}"><i class="fa fa-circle-o"></i> All Orders</a></li>
          </ul>
        </li>
      </ul>
    </section>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; {{date('Y')}} <a href="http://www.rupahali.com">www.rupahali.com</a></strong> All rights
    reserved.
  </footer>

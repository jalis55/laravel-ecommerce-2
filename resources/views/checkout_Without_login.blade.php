...
<header id="header">
         	    ...
         	    <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <p style="color: green;padding:0 30px;font-size: 18px">You are currently as Guest user mode. Please Sign In for better buying experience.</p>
                                        ...
                                        <textarea type="text" placeholder="Enter Shipping Address in details..(House No,Road No,Vill etc)"  class="form-control input" name="customer_address" rows="5" style="resize: none;" required>  @if(Auth::check()) {{Auth::user()->address}} @endif </textarea>
                                    
                                        <label>Phone</label>
                                        <input type="text" placeholder="Mobile Number" @if(Auth::check()) value="{{Auth::user()->phone}}" @endif  class="form-control input" name="customer_phone" required>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="panel panel-info">
                                <div class="panel-body">
                                     <h3 class="text-center"><span class="fa fa-lock"></span> Log In</h3>
 ...
 <div class="text-center" style="min-height: 150px;background-color: #F3F3F3;">
                                          <p style="color: green;padding-top: 40px;font-size: 18px">New to Rupahali ? Join today!.</p>
